 ...
 * @returns {Array<any>}
 */
export function extract_7z(bytes) {
    try {
 ...
 * @returns {Uint8Array}
 */
export function inflate_raw(bytes, expected_size) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function lzma_decode(props, dict_size, data, out_size) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('unpack_buffered_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
