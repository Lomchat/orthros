...
/** Split MSVC/x87 truncation into EDX:EAX. Invalid and overflowing values use
 * the x87 indefinite integer, not JavaScript's saturating float conversion. */
...
/** Emergency JS tier. Production calls are served by WASM handler 17; keeping
 * a faithful fallback means diagnostics can disable raw hypercalls safely. */
export const bfmeFtol2SseHandler: ThunkImplementation = () => {
